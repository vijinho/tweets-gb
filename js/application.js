...
//
  ...
  (function (exports){
    ...
    exports.localizeStrings = function() {
      ...
      $('#footer-text').append("This is a searchable archive of Tweets from Twitter (using <a target='new' href='https://github.com/vijinho/tweets-gb'>@vijinho/tweets-gb</a>) Use the months above to navigate the archive.");
