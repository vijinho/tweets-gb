...
//
  ...
  (function (exports){
    ...
    exports.localizeStrings = function() {
      ...
      $('#footer-text').append("This is a searchable archive of Tweets from Twitter. Use the months above to navigate the archive. The source code for this viewer is available at: <a target='new' href='https://github.com/vijinho/tweets-gb'>github.com/vijinho/tweets-gb</a>");
